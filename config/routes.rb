Rails.application.routes.draw do
  ...
  post("/create_rating_from_album", { :controller => "ratings", :action => "create_row_from_album" })
  ...
  post("/create_album_from_artist", { :controller => "albums", :action => "create_row_from_artist" })
